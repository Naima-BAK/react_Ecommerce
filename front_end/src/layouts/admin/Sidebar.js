        ...
        <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div className="sb-sidenav-menu">
                <div className="nav">
                    ...
                    <Link className="nav-link collapsed" to="/admin/ViewCategory" data-bs-toggle="collapse" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                    ...
                    <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav className="sb-sidenav-menu-nested nav">
                            <Link className="nav-link" to="/admin/ViewCategory">liste des catégories</Link>
                            <Link className="nav-link" to="/admin/Addcategory">Ajouter un catégorie</Link>
                        </nav>
                    </div>
